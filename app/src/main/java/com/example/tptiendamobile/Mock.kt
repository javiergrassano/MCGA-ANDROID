...
fun mockTeam(): MutableList<Team> {
    ...
    teamList.add(Team("https://pps.whatsapp.net/v/t61.24694-24/64382691_2443235555761207_2978949227280859136_n.jpg?oh=4bd50936e37dfd5a99f34a940247bee9&oe=5F5A4EB4", "Juan Gonzales", "Analista funcional"))
    teamList.add(Team("https://instagram.faep8-2.fna.fbcdn.net/v/t51.2885-15/e35/p1080x1080/89965720_134255664777892_6617766245046632186_n.jpg?_nc_ht=instagram.faep8-2.fna.fbcdn.net&_nc_cat=104&_nc_ohc=qeJ-c8WqHA4AX9ZhL3C&oh=d324277b3e1f1dc33711c6b28f0ef116&oe=5F7F1C50", "Agustin Zalazar", "Maquetador"))
    teamList.add(Team("https://media-exp1.licdn.com/dms/image/C4E03AQGirc6qtt2QsQ/profile-displayphoto-shrink_200_200/0?e=1605139200&v=beta&t=wiFAT-EJ4MK_LiyhMblhjrrR_Wa_AECLW3SCA9ISFqA", "Bruno Mahiques", "Analista funcional"))
